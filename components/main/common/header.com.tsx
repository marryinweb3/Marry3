...
export function W3Modal() {
  return (
    <div className="sc-AxgMl hkzEld web3modal-modal-lightbox">
      <div
        className="sc-AxheI fdbjE web3modal-modal-container"
        onClick={async () => {
          try {
            walletStore.showModal = false;
            await eth.connect();
          } catch (e) {
            message.error("please check your wallet status");
          }
        }}
      >
        ...
        <div className="sc-AxmLO bfIkEQ web3modal-modal-card">
          <div className="sc-AxhUy kaSVED web3modal-provider-wrapper">
            <div className="sc-AxhCb xPSun web3modal-provider-container">
              <div className="sc-AxjAm bcMPWx web3modal-provider-icon">
                <img
              ...
              <div className="sc-AxirZ hBmmHr web3modal-provider-name">
                MetaMask
              </div>
              <div className="sc-AxiKw ceSpQQ web3modal-provider-description">
...
export const Header = (props: {
  ...
  return useObserver(() => (
    <div className={styles.header}>
      ...
      {walletStore.showModal ? <W3Modal></W3Modal> : null}
    </div>
  ));
};
