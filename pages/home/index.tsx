          ...
          <div className={[styles.Page_3, "shake-trigger"].join(" ")}>
            <div className={styles.Page_inner}>
              ...
              <div className={styles.about_content}>
                <p>
                  <span>
                    <Trans id="从开始迈入 Web3 世界的那一刻开始，我就时常在思考一个问题：Web3 是什么？是信息革命？是所有权革命？还是社会治理模式的革命？它是工具？还是泡沫？亦或是一切的救赎？" />
                  </span>
                </p>
                <p>
                  <span>
                    <Trans id="不论最终结论是什么，但我可以确信一点，这是一个从零开始重塑的新世界，它拥有全新的秩序和规则（Code is Law），全新的组织方式（DAO），全新的身份认同（NFT&ENS），以及全新的原住民（0x地址）。" />
                  </span>{" "}
                </p>
                <p>
                  <span>
                    <Trans id="所以，我想发起一场社会实验，与新世界的所有住民一起探索一种全新的身份认同。" />
                  </span>{" "}
                </p>
                <p>
                  <Trans id="它就是 " />{" "}
                  <img
                    src="/logo.png"
                    title="marry3"
                    style={{ width: "100px", verticalAlign: "-8px" }}
                  />
                </p>
                <p>
                  <span>
                    <Trans id="因为它发生在新世界，所以它将破除物理空间的限制，不限性别、不限年龄、不限种族，甚至不限物种（0x地址原住民的背后可能是任何物种，例如阿猫或者阿狗）。" />
                  </span>{" "}
                </p>
                <p>
                  <span>
